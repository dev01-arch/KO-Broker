...
-- Run manually via: psql $DIRECT_URL -f packages/db/prisma/migration-prd15-intelligence.sql
-- Or via: prisma migrate dev --name prd15-intelligence (generates equivalent migration)
--
-- This is ADDITIVE ONLY — no DROP, no ALTER COLUMN with data loss.
-- Safe to run on shared Supabase.
