          ...
          <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
            ...
            {showDetailsForm && (
              <>
                ...
                <Field
                  label={isCompany ? 'Annual turnover / income (┬ú)' : 'Annual income (┬ú)'}
                ...
                {selectableAdvisers.length > 0 && (
                  <Field label="Adviser" required error={fieldErrors.assignedMemberId}>
                    ...
                    >
                      {isAdmin && (
                        <option value="">
                          {advisersLoading ? 'Loading advisersΓÇª' : 'Select adviser'}
                        </option>
                      )}
          ...
          <div className="border-t border-ink-20 px-6 py-4 flex items-center justify-end gap-3">
            ...
            {showDetailsForm && (
              ...
              >
                ...
                {isPending ? 'CreatingΓÇª' : 'Create client'}
              </button>
            )}
            {showReferredCompanyStep && (
              <button
...
// ΓöÇΓöÇΓöÇ Small helpers ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
