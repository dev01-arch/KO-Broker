...
function formatAdviserName(member: { firstName: string; lastName: string } | null) {
  if (!member) return 'ΓÇö';
  return [member.firstName, member.lastName].filter(Boolean).join(' ') || 'ΓÇö';
}
        ...
        <div className="flex items-center gap-3">
          <div className="relative flex-1 max-w-sm">
            ...
            <input
              ...
              placeholder="Search name, email, referenceΓÇª"
        ...
        <div className="rounded-xl border border-ink-20 bg-white overflow-hidden">
          {isLoading ? (
            <div className="flex items-center justify-center py-20 text-ink-60">
              ...
              <span className="text-sm">Loading clientsΓÇª</span>
            </div>
          ) : isError ? (
            <ApiErrorState
              error={error}
