...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex min-h-screen bg-surface">
      {/* Sidebar — will be a component from PRD-06 */}
      <aside className="flex w-[220px] shrink-0 flex-col gap-0.5 border-r border-ink-20 bg-white px-3 py-5">
        ...
        <div className="mt-1 px-3 text-[10px] font-bold uppercase tracking-wider text-ink-60">
          Main
        </div>
        <a
          href="/dashboard"
        ...
        <div className="mt-3 px-3 text-[10px] font-bold uppercase tracking-wider text-ink-60">
          Tools
        </div>
        <a
